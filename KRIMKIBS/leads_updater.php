<?php
    ...
    foreach($leadsData as $key => $lead) {
        ...
        $data = array(
            ...
            "closed_at" => ($lead->closed_at != null) ? DateTime::createFromFormat('U', $lead->closed_at)->setTimezone(new DateTimeZone('Europe/Moscow'))->format('Y-m-d H:i:s') : null,
            "created_at" => ($lead->created_at != null) ?DateTime::createFromFormat('U',$lead->created_at)->setTimezone(new DateTimeZone('Europe/Moscow'))->format('Y-m-d H:i:s') : null,
            "updated_at" => ($lead->updated_at != null) ? DateTime::createFromFormat('U',$lead->updated_at)->setTimezone(new DateTimeZone('Europe/Moscow'))->format('Y-m-d H:i:s') : null,
