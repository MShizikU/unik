...
`,hs=H().span`
  ...
  font-size: 0.929em;
  color: black;
`;var ms=Object.defineProperty,fs=Object.getOwnPropertySymbols,ys=Object.prototype.hasOwnProperty,gs=Object.prototype.propertyIsEnumerable,bs=(e,t,r)=>t in e?ms(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,xs=(e,t)=>{for(var r in t||(t={}))ys.call(t,r)&&bs(e,r,t[r]);if(fs)for(var r of fs(t))gs.call(t,r)&&bs(e,r,t[r]);return e};function vs(t){const{Label:r=hs,Dropdown:n=ds}=t;return 1===t.options.length?e.createElement(r,null,t.options[0].value):e.createElement(n,xs({},t))}var ws=require("dompurify");const ks=Y`
  a {
...
`,Os=ee(Vi)`
  ...
  ${te("Markdown")};
`;var Es=Object.defineProperty,js=Object.defineProperties,$s=Object.getOwnPropertyDescriptors,Ss=Object.getOwnPropertySymbols,Ps=Object.prototype.hasOwnProperty,Cs=Object.prototype.propertyIsEnumerable,As=(e,t,r)=>t in e?Es(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Is=(e,t)=>{for(var r in t||(t={}))Ps.call(t,r)&&As(e,r,t[r]);if(Ss)for(var r of Ss(t))Cs.call(t,r)&&As(e,r,t[r]);return e};const Ts=H()((t=>e.createElement(Os,Is({},t))))`
  display: inline;
...
`;let Ca=class extends e.Component{render(){const{externalDocs:t}=this.props;return t&&t.url?e.createElement(Pa,{$compact:this.props.compact},e.createElement("a",{href:t.url},t.description||t.url)):null}};Ca=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ha.observer],Ca);class Aa extends e.PureComponent{constructor(){super(...arguments),this.state={collapsed:!0}}toggle(){this.setState({collapsed:!this.state.collapsed})}render(){const{values:t,isArrayType:r}=this.props,{collapsed:n}=this.state,{enumSkipQuotes:o,maxDisplayedEnumValues:i}=this.context;if(!t.length)return null;const s=this.state.collapsed&&i?t.slice(0,i):t,a=!!i&&t.length>i,l=i?n?`… ${t.length-i} more`:"Hide":"";return e.createElement("div",null,e.createElement(fa,null,r?_("enumArray"):""," ",1===t.length?_("enumSingleValue"):_("enum"),":")," ",s.map(((t,r)=>{const n=o?String(t):JSON.stringify(t);return e.createElement(e.Fragment,{key:r},e.createElement(Ea,null,n)," ")})),a?e.createElement(Ia,{onClick:()=>{this.toggle()}},l):null)}}Aa.contextType=ce;const Ia=ee.span`
  color: ${e=>e.theme.colors.primary.main};
  vertical-align: middle;
  font-size: 13px;
  line-height: 20px;
...
`,Bc=ee(Tc)`
  margin: 0 5px 0 0;
`,Qc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(qc,{className:o,onClick:i||void 0},e.createElement(Bc,{type:s},gt(s)),e.createElement(Pi,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(Fc,{$deprecated:a},r),a?e.createElement(Ci,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
